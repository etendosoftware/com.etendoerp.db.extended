...
public final class VectorQuery {
  ...
  public VectorQuery(String namespace, double[] vector, int topK, DistanceMetric metric, String metadata, String clientId, String organizationId) {
    this(namespace, vector, topK, metric, metadata, VectorMetadataFilter.jsonContains(metadata == null ? "{}" : metadata), clientId, organizationId);
  }
  VectorQuery(String namespace, double[] vector, int topK, DistanceMetric metric, String metadata, VectorMetadataFilter metadataFilter, String clientId, String organizationId) {
